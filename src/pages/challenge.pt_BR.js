...
const Challenge = () => {
  return (
    <ChallengePage
      ...
      seoDescription="A Universidade de Helsinki e a Houston Inc. se uniram para desafiar tanto desenvolvedores individuais quanto empresas a aprender e a aprimorar suas habilidades em desenvolvimento de software de uma verdadeira forma Full Stack. O curso é construído por programadores para programadores e oferece valor tanto para iniciantes quanto para veteranos da indústria."
      aboutContent={[
        'O mundo precisa desesperadamente de desenvolvedores de software. Queremos ajudar a criar a próxima geração de programadores — um dos nossos métodos oferecidos é se inscrever no curso MOOC Full Stack.',
        'A Universidade de Helsinki e a Houston Inc. se uniram para desafiar tanto desenvolvedores individuais quanto empresas a aprender e a aprimorar suas habilidades no verdadeiro espírito Full Stack. Entre nossos afiliados e pioneiros do desafio estão Elisa Oyj, K-ryhmä, Konecranes Oyj, Terveystalo Oyj e a Unity Technologies Finland Ltd.',
        'Nosso objetivo é incentivar o aprendizado. Oferecemos um curso Full Stack completamente elaborado e com escopo que propositalmente diminui a barreira de entrada para aprender sobre novas tecnologias de ponta e de produção. O curso é gratuito e você pode participar de qualquer lugar e em qualquer hora, quando você desejar.',
