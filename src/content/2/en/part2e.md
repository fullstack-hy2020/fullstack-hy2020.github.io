...
The variable *notesToShow* is first assigned the value of the state *notes* and then the code tries to call method *map* to an nonexisting object, that is, to *null*.
