...
Jos ensimmäinen osa evaluoituu epätodeksi eli on [falsy](https://developer.mozilla.org/en-US/docs/Glossary/Falsy) (eli <i>user</i> on jo määritelty, jolloin <i>!user</i> on falsy), ei toista osaa eli login-lomakkeen generoivaa koodia suoriteta ollenkaan.
