...
**NB:** A better method of selecting elements for testing is setting id-attributes that are inserted into the code specifically for testing purposes. We can then use something like [getByTestId](https://testing-library.com/docs/queries/bytestid/), that looks for elements based on the specified id-attribute.
