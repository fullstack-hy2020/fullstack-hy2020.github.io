...
Separate the form for creating a new blog into its own component (if you have not already done so), and pass all the states required for creating a new blog as props to this component. 
