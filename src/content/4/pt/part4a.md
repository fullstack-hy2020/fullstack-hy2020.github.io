...
Antes de adentrarmos no tópico de testes, nós iremos modificar a estrutura do projeto para derir às melhores práticas do Node.js.
...
Você pode encontrar o código atual da nossa aplicação na branch <i>part4-1</i> [neste respositório GitHub](https://github.com/fullstack-hy2020/part3-notes-backend/tree/part4-1).
...
#### 4.7*: funcões auxiliares e testes unitários, passo 5
