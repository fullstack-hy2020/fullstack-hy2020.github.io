...
在第一行，测试文件导入要测试的函数，并将其赋值给一个名为回文的变量:
...
如果定义您自己的博客测试输入列表工作量太大，您可以使用现成的列表[这里]( https://github.com/fullstack-hy2020/misc/blob/master/blogs_for_test.md 文档)。
