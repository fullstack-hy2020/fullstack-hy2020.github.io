...
قبل تقنية AJAX, كانت صفحات الانترنت تعمل ب [التقنيات التقليدية](/ar/part0/fundamentals_of_web_apps#traditional-web-applications) والتى تعرضنا اليها في هذا الجزء.
...
يمكن الاطلاع على المعلومات الخاصة بذلك التمرين واثنين من التمارين التالية [هنا](/ar/part0/fundamentals_of_web_apps#forms-and-http-post).
...
قم بإنشاء رسم توضيحي لحالة التطبيق عندما يقوم المستخدم بزيارة ذلك الرابط [single-page app](/ar/part0/fundamentals_of_web_apps#single-page-app) المطور بتقنية الصفحة الواحدة من هنا <https://studies.cs.helsinki.fi/exampleapp/spa>.
