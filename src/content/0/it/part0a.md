...
Questo corso è un'introduzione al moderno sviluppo web con JavaScript. Il focus principale è sulle applicazioni a pagina singola (Single Page Applications) implementate con React e sul loro supporto con servizi web RESTful e GraphQL implementati con Node.js. Il corso ha anche parti su TypeScript, React Native e integrazione continua.

Altri argomenti includono il debug delle applicazioni, la configurazione, la gestione degli ambienti di runtime e i database NoSQL.

### Prerequisiti

Ci si aspetta che i partecipanti abbiano buone capacità di programmazione, una conoscenza di base della programmazione web e dei database, e la padronanza del sistema di gestione delle versioni Git. Ci si aspetta anche che tu abbia perseveranza e una capacità di risolvere i problemi e cercare informazioni in modo indipendente.

Non è richiesta una precedente conoscenza di JavaScript o di altri argomenti del corso.

### Materiale del corso

Il materiale del corso è pensato per essere letto una parte alla volta e in sequenza.

Il materiale contiene esercizi che sono posizionati in modo che il materiale precedente fornisca informazioni sufficienti per risolvere ogni esercizio. Puoi fare gli esercizi man mano che li incontri nel materiale, ma può anche essere utile leggere tutto il materiale della parte prima di iniziare con gli esercizi.

In molte parti del corso, gli esercizi contribuiscono a costruire un'applicazione più grande in maniera graduale e un pezzo alla volta. Alcune delle applicazioni degli esercizi sono sviluppate attraverso più parti.

Il materiale del corso è basato su applicazioni di esempio in espansione incrementale, che cambiano di parte in parte. È meglio seguire il codice mentre si fanno piccole modifiche in modo indipendente. Il codice delle applicazioni di esempio per ogni passo di ogni parte può essere trovato su GitHub.

### Seguire il corso

Il corso contiene tredici parti, la prima delle quali è numerata 0 per coerenza con le iterazioni passate. Una parte corrisponde vagamente a una settimana (in media 15-20 ore) di studio, ma la velocità di completamento del corso è flessibile.

Procedere dalla parte <i>n</i> alla parte <i>n+1</i> non ha senso prima di aver raggiunto una conoscenza sufficiente degli argomenti della parte <i>n</i>. In termini pedagogici, il corso segue la metodologia [Mastery Learning](https://en.wikipedia.org/wiki/Mastery_learning), di conseguenza, si dovrebbe procedere alla parte successiva solo dopo aver fatto abbastanza esercizi nella parte precedente.

Il corso prevede che siano svolti <i>almeno</i> tutti gli esercizi che non sono segnati con un asterisco (\*). Gli esercizi segnati con un asterisco contano per il voto finale, ma saltarli non impedisce di fare gli esercizi obbligatori nella parte successiva.

La velocità di completamento del corso è flessibile, e gli esercizi possono essere presentati fino alle 23:59 [EET](https://en.wikipedia.org/wiki/Eastern_European_Time) del 1 marzo 2022.

Tuttavia, si noti che il termine ultimo per sostenere l'esame per i crediti dell'Università di Helsinki è il 10.1.2022.

Le statistiche sul tempo di completamento degli esercizi possono essere trovate tramite il [sistema di invio](https://studies.cs.helsinki.fi/stats/courses/fullstackopen).

### Parti e completamento

Gli studi Full Stack consistono nel corso principale e in diverse estensioni. E' possibile completare gli studi al fine di raggiungere da 5 a 13 crediti.

#### Parti 0-5 (corso principale) - Full Stack Web Development (5 cr, AYCSM141081en)

Il numero di crediti e il voto del corso si basano sul numero totale di esercizi presentati per le parti 0-7 (inclusi gli esercizi contrassegnati da un asterisco).

I crediti e i voti sono calcolati come segue:
...
L'ultima data possibile per sostenere l'esame è il 10 gennaio 2022. \*\*Nota che ci si deve iscrivere all'esame entro e non oltre il 9 gennaio 2022.

Si può sostenere l'esame solo dopo aver presentato abbastanza esercizi per cinque crediti. Non è saggio in pratica fare l'esame subito dopo aver presentato il numero critico di esercizi. L'esame è lo stesso per 5-13 crediti e non conta per il tuo voto.

<i>Non è necessario partecipare all'esame del corso o iscriversi al corso della Open University per ottenere il certificato del corso</i>.

#### Parte 6 - Full Stack Web Development, estensione 1 (1 cr, AYCSM141082en)

Questa estensione permette di ottenere un credito aggiuntivo presentando almeno 127 degli esercizi inerenti le parti 0-7.
...
Questa estensione permette di ottenere un credito aggiuntivo presentando almeno 138 degli esercizi inerenti le parti 0-7.
...
Presentando almeno 22/26 degli esercizi della parte 8 del corso, GraphQL, è possibile ottenere un credito aggiuntivo. La parte 8 può essere fatta in qualsiasi momento dopo la parte 5, perché i suoi contenuti sono indipendenti dalle parti 6 e 7.
...
Presentando almeno 24/27 degli esercizi per la parte 9 del corso, TypeScript, è possibile ottenere un credito aggiuntivo. Si raccomanda di completare le parti 0-7 prima di partecipare alla parte 9.
...
Nota che per ricevere i crediti universitari e' necessario un numero di previdenza sociale finlandese.

Se vuoi ricevere i crediti, salva il tuo <b>numero di studente dell'Università di Helsinki</b> nel
[sistema di invio degli esercizi](https://studies.cs.helsinki.fi/stats/courses/fullstackopen)
