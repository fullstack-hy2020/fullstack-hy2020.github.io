...
The exercises are submitted via GitHub, and marking the exercises is done in the "my submissions" tab of the [submission system](https://studies.cs.helsinki.fi/stats/courses/fullstackopen).
