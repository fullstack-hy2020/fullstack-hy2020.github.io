...
Also, make sure that the frontend still works locally (in development mode when started with command _npm start_. Make sure that your backend code is also running on another port to see the user name in the frontend repository).
