...
If you decide to use the [Fly.io](https://fly.io/) begin by cereating an account. By default everyone gets two free virtual machines that can be used for running two apps at the same time.
