...
**Note**: Logging data even in console is quite dangerous since it can contain sensitive data and may violate local privacy law (e.g. GDPR in EU) or business standard. In practice, try not to log any sensitive data.
