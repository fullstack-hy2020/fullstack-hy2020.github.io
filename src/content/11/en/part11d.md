...
See [these examples](https://docs.github.com/en/free-pro-team@latest/actions/reference/context-and-expression-syntax-for-github-actions#example-printing-context-information-to-the-log-file) how to access the commit message content when implementing the <code>if</code> condition.
