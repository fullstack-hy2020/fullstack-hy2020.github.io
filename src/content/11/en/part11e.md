...
- Now browse https://api.telegram.org/bot<BOT_TOKEN>/getUpdates to view the event log of our bot, and look for something <i>title: "My CI-CD Notifications"</i> you'll notice there is the <i>id</i> for the group in there too. That is our <i>chat id</i> for the group, it looks something like -123456789.
...
Tip: You can get the <i>chat id</i> of your personal telegram account by sending a "Hello" message to <i>@userinfobot</i> simply. Also, if you are using [web version of telegram](https://web.telegram.org/) on your desktop, you can use this link [@userinfobot](https://t.me/userinfobot) as well.
