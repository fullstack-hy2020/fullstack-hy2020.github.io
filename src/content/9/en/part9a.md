...
**The language** concists of a syntax which slightly differs from JavaScript, keywords and type annotations. From the three parts of TypeScript programmers have the most direct contact with the language. 
...
Below is an step by step example of type inference in TypeScript.
