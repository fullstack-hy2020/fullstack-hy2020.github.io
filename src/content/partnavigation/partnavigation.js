module.exports = {
  ...
  it: {
    '0': {
      a: 'Informazioni generali', // TODO
      b: 'Fondamenti di applicazioni Web',
    },
    '1': {
      a: 'Introduzione a React',
      b: 'JavaScript',
      c: 'Stato dei componenti, event handlers',
      d: 'Stato complesso, debug di app React',
    },
    '2': {
      a: 'Visualizzare una collezione, moduli',
      b: 'Form',
      c: 'Leggere dati dal server',
      d: 'Modificare dati nel server',
      e: 'Aggiungere gli stili a una app React',
    },
    '3': {
      a: 'Node.js e Express',
      b: 'Rilasciare l\'app in rete',
      c: 'Salvare i dati su MongoDB',
      d: 'Validazione e ESLint',
    },
    '4': {
      a: 'Struttura di un\'applicazione backend, introduzione al testing',
      b: 'Test del backend',
      c: 'Amministrazione degli utenti',
