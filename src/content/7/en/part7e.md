...
For class components, each method that is used within the render method must be bound in the constructor using the bind method. Without this method, when the button is clicked, the button will not update the state as it will be undefined.
