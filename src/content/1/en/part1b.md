...
Here an array filled with integer values is transformed into an array containing strings of HTML using the map method. In [第2章](/en/part2) of this course, we will see that map is used quite frequently in React.
